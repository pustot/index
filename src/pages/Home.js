    ...
    return (
      <div>
        ...
        <Stack spacing={4} px={2} pb={4}>
          ...
          {getLocaleText(
                {"en": "Web Apps", "zh-Hant": "Web 應用", "zh-Hans": "Web 应用", "tto-bro": "Fab OeZ3Ee7Z3", "tto": "Fab RhSe",
                 "ja": "Webアプリ", "de": "Webanwendungen"}, 
                lang
              )}
          </Typography>
