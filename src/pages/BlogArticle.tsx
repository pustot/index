...
export default function BlogArticle(props: { lang: LangCode }) {
    ...
    const fetchContent = async () => {
        let text = await (await fetch("https://raw.githubusercontent.com/pustot/blog/main/" + fileName)).text();
        if (text == "") return;
        text = text.replaceAll("](./pic/", "](https://raw.githubusercontent.com/pustot/blog/main/pic/");
